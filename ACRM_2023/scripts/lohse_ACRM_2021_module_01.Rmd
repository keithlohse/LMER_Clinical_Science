...
PRED<-data.frame(subID=c("s01","s02","s03","s04","s05","s06","s07","s08","s09", "s10"), Intercepts=c(coef(raneff_int)$subID[c(1:10),])) 
PRED
```
...
PRED<-data.frame(subID=c("s01","s02","s03","s04","s05","s06","s07","s08","s09", "s10"), Intercepts=c(coef(raneff_slope)$subID[c(1:10),1]), Slopes=c(coef(raneff_slope)$subID[c(1:10),2])) 
PRED
...
PRED<-data.frame(subID=c("s01","s02","s03","s04","s05","s06","s07","s08","s09", "s10"), Intercepts=c(coef(raneff_lin_rand)$subID[c(1:10),1]), Slopes=c(coef(raneff_lin_rand)$subID[c(1:10),2])) 
PRED
