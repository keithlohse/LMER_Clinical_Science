...
```{r, simulating two different populations, tidy=TRUE}
...
# simulate observations per person (everyone has 1st observation)
time <- unlist(sapply(p, function(x) # p is fed into our function
  c(1, # everyone has first observation
    sort(sample(x=2:max_obs, # take samples of size 2 to max observation
                size = x-1, # sample sizes are the max value of p-1 for each person
...
```{r, resampling and fitting the model, tidy=TRUE}
# set sample sizes
...
Converting results from lists to dataframes...
...
Something something something....
```{r, figure 3, fig.height = 5, fig.width = 5.5, fig.align="center"}
...
```{r, figure 4, fig.height = 2, fig.width = 8, fig.align="center"}
# Plots showing the estimation of the true parameters ----
cbPalette <- c("#D55E00", "#56B4E9", "#009E73", "#000000", 
               "#F0E442", "#0072B2", "#E69F00", "#CC79A7",
               "#999933", "#882255", "#661100", "#6699CC")
...
```{r, figure 5, fig.height = 6, fig.width = 6, fig.align="center"}
# Plots showing the estimation of the true parameters ----
cbPalette <- c("#D55E00", "#56B4E9", "#009E73", "#000000", 
               "#F0E442", "#0072B2", "#E69F00", "#CC79A7",
               "#999933", "#882255", "#661100", "#6699CC")
